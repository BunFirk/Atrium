...
export function Header() {
  return (
    <div className="w-full h-[612px] bg-fixed bg-[url('https://images.unsplash.com/photo-1523755231516-e43fd2e8dca5?q=80&w=1635&auto=format&fit=crop')] bg-cover bg-center">
